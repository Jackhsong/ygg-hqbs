package com.ygg.webapp.sdk.weixin;
...
import com.ygg.webapp.sdk.weixin.util.MD5Util;
import com.ygg.webapp.sdk.weixin.util.TenpayUtil;
...
public class RequestHandler
{
    ...
    public String createSign(SortedMap<String, String> packageParams)
    {
        ...
        // return MD5.sign(sb.toString(), this.getKey(), "UTF-8").toUpperCase();
    ...
    public static String createSign(String charSet, SortedMap<Object, Object> parameters)
    {
        ...
        sb.append("key=" + CommonConstant.APPSECRET);// xxxxxx换成你的API密钥
    ...
    protected void createSign()
    {
        ...
        sb.append("key=" + CommonConstant.APPSECRET); // 自己的API密钥
