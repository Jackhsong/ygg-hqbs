...
public class AlipayNotify
{
    ...
    public static boolean verifyGlobal(Map<String, String> params)
    {
        ...
        if (params.get("notify_id") != null)
        {
            ...
            responseTxt = verifyResponseGlobal(notify_id);
        }
        String sign = "";
        if (params.get("sign") != null)
        {
     ...
     */
    private static String verifyResponseGlobal(String notify_id) {
        //获取远程服务器ATN结果，验证是否是支付宝服务器发来的请求

        String partner = AlipayConfig.global_partner;
        String veryfy_url = HTTPS_VERIFY_URL + "partner=" + partner + "&notify_id=" + notify_id;
    ...
    private static boolean getSignVeryfy(Map<String, String> Params, String sign) {
        ...
        if(AlipayConfig.global_sign_type.equals("MD5") ) {
            isSign = MD5.verify(preSignStr, sign, AlipayConfig.global_key, AlipayConfig.input_charset);
        }
        return isSign;
    }
