...
<head>
    ...
    <style>
      *{margin: 0;padding: 0;font-family: 'microsoft yahei';-webkit-touch-callout:none;}
              ...
              .mimg{width: 70%;}
              .mtext{color: #b1442f;font-size: 30px;width: 550px;margin: 0 auto;}
              .mtext dt{font-size: 35px;line-height: 180%;}
    </style>
    
<body>
<div class="protips"></div>
<div class="mbox">
<input type="hidden" value=${channelId?c} id="channelId" />
    ...
    <div class="mbox1" id="mbox1">
        <div style="text-align:center;">领取${title}</div>
    ...
    <div style="text-align: center">加掌柜个人微信号：<span style="font-weight: bolder;color: red">lovegegejia07</span> ，更多彩蛋等你领！</div>
    <dl class="mtext">
        <dt>现金券使用方式:</dt>
        <dd>1、输入正确手机号码领取现金券；</dd>
        <dd>2、下载左岸城堡APP，使用输入的手机号注册并登陆；</dd>
        <dd>3、购物付款前，选择现金券即可抵扣。</dd>
   </dl>
	...
	setTimeout(function(){			
        ...
        $(function(){
            ...
            $mbtn.on('click',function(){
                ...
                $.ajax({
                    url: '${rc.contextPath}/spreadChannel/receive',
                    type: 'post',
                    dataType: 'json',
                    data: {
                    	channelId:channelId,
