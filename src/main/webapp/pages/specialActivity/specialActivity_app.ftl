...
<head lang="en">
    ...
    <style>
        ...
        .repeatModel li{background: #fff;margin-bottom: 0.1rem;padding-bottom: 0.35rem;border-radius: 3px;}
        .repeatModel .tit{color: #000000;font-size: 0.45rem;line-height: 150%;width: 95%;margin:0 auto;display: block;margin-top:.1rem;}
        .repeatModel .desc{color: #505050;display:block;font-size: 0.4rem;line-height: 150%;width: 95%;margin-left:0.17rem;display: block;}
        .repeatModel .price{width: 95%;display:block;margin: 0 auto;}
        .repeatModel .price i{margin-top: 0.3rem;}
        .repeatModel .price .oldPrice{margin-top: 0.35rem;}
        .repeatModel .img{position:relative;height:4.69rem;overflow: hidden;display: block;border-top-left-radius: 3px;border-top-right-radius: 3px;}
        .repeatModel .img img{display: inline-block;vertical-align:middle;border-top-left-radius: 3px;border-top-right-radius: 3px;height:4.7rem;}
        ...
        .repeatModel .double .desc{font-size: 0.35rem;line-height: 130%;height:1.35rem;overflow: hidden;}
        ...
        @media screen and (device-aspect-ratio: 40/71) {
            ...
            .repeatModel .price .oldPrice{margin-top: 0.28rem;margin-left: 0.2rem;}
    ...
    <#list list.productList as list2>
        ...
        <li class="double box">
            ...
            <div class="right fl">
                ...
                <a href="${list2.right.url}" class="desc">${list2.right.desc}</p>
...
<script>
    ...
    var events={
        init:function(){
			...
			$("#nav").height($(".navList").height()+"px");
			$("#navWrap").height($(".navList").height()+"px");
			$(window).on("scroll",function(){
            ...
            setTimeout(this.clickScroll,500);
            this.toTop();  
        },
