...
<head>
    ...
    <style>
        *{margin: 0;padding: 0;font-family: sans-serif;-webkit-touch-callout:none;}
        ...
        p{text-align: center;font-size: 24px;line-height: 40px;color: #564400;}
    	...
    	.share_wx{width: 100%;height: 100%;background: rgba(0,0,0,.7);position: absolute;left: 0;top: 0;z-index:10;}
        .share_wx img{position: fixed;top: 0;left: 0;width: 100%;}
        .share_wx .close{width: 20%;padding-bottom:150px;background: url("${rc.contextPath}/pages/images/spead/close.png") no-repeat;background-size: 100%;position: fixed;top: 5px;left: 0;display: block;}
    </style>
    
<body>
<div class="share_wx" id="share_wx">
	<i class="close"></i>
	<img src="${rc.contextPath}/pages/images/spead/shareImg.png"/>
</div>
...
<div class="mbox">
    ...
    <img src="${rc.contextPath}/pages/images/spead/2.jpg" alt=""/>
    <div class="mbox1" id="mbox1">
        <div style="text-align:center;">领取左岸城堡10元新人现金券</div>
	...
	setTimeout(function(){			
        ...
        $(function(){
            ...
            $mbtn.on('click',function(){
                ...
                $.ajax({
                    url: '${rc.contextPath}/user/invite',
                    type: 'post',
                    dataType: 'json',
                    data: {
                    	mobileNumber: _val,
