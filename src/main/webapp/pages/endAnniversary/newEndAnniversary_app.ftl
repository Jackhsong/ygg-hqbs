...
<head lang="en">
    ...
    <style>
        ...
        /*****头部*****/
        header{background: url("${rc.contextPath}/pages/images/endAnniversary/top_banner_new.jpg") no-repeat;background-size:100%; width: 100%; height: 9.95rem; position: relative;}
    ...
    height: 1.62rem; left: 0.8rem; top:0.8rem;color: #fff; font-size: 0.4rem; text-align: center;}
	        ...
	        #sale-top .numLinksTop{ background:url("${rc.contextPath}/pages/images/endAnniversary/sale_topBg_new.gif") no-repeat;background-size:100%; width: 100%; height: 9.58rem; position: relative;}
		...
		/*****尾部*****/
		footer{background: url("${rc.contextPath}/pages/images/endAnniversary/bottom_bg02.jpg") no-repeat;background-size:100%; width: 100%; height: 8.3rem; position: relative;}
		footer .weixinNum{ position: absolute;color:#ff2939;font-size: 0.62rem; width: 6.0rem; left: 2.08rem;top:5.13rem; text-align: center;}
		...
		<article id="container">
			...
			<div id="sale-top" class="numLinks">
				<div class="numLinksTop">
					<div class="saleLink">
						<a href="ggj://redirect/resource/saleProduct/13538" class="num01"></a>
						<a href="ggj://redirect/resource/saleProduct/15361" class="num02"></a>
						<a href="ggj://redirect/resource/saleProduct/27057" class="num03"></a>
					</div>
				</div>
			...
			<div id="kbhpb-top" class="numLinks">
				<div class="numLinksTop">
					<div class="saleLink">
						<a href="ggj://redirect/resource/saleProduct/19114" class="num01"></a>
						<a href="ggj://redirect/resource/saleProduct/18565" class="num02"></a>
						<a href="ggj://redirect/resource/saleProduct/13392" class="num03"></a>
					</div>
				</div>
			...
			<div id="fgzgb-top" class="numLinks">
				<div class="numLinksTop">
					<div class="saleLink">
						<a href="ggj://redirect/resource/saleProduct/18785" class="num01"></a>
						<a href="ggj://redirect/resource/saleProduct/19054" class="num02"></a>
						<a href="ggj://redirect/resource/saleProduct/18901" class="num03"></a>
					</div>
			...
			<div id="rqdhb-top" class="numLinks">
				<div class="numLinksTop">
					<div class="saleLink">
						<a href="ggj://redirect/resource/saleProduct/23656" class="num01"></a>
						<a href="ggj://redirect/resource/saleProduct/3567" class="num02"></a>
						<a href="ggj://redirect/resource/saleProduct/18203" class="num03"></a>
					</div>
			...
			<div id="other-goods">
				<div class="otherGoods-container">
					<ul class="clearfix">
						<li>
							<a href="ggj://redirect/resource/appCustomActivitiesDetail/1003"><img src="${rc.contextPath}/pages/images/endAnniversary/recommend_img01.jpg"/></a>
						</li>
						<li>
							<a href="ggj://redirect/resource/appCustomActivitiesDetail/1004"><img src="${rc.contextPath}/pages/images/endAnniversary/recommend_img02.jpg"/></a>
						</li>
						<li>
							<a href="ggj://redirect/resource/appCustomActivitiesDetail/1005"><img src="${rc.contextPath}/pages/images/endAnniversary/recommend_img03.jpg"/></a>
						</li>
						<li>
							<a href="ggj://redirect/resource/appCustomActivitiesDetail/1006"><img src="${rc.contextPath}/pages/images/endAnniversary/recommend_img04.jpg"/></a>
						</li>
						<li>
							<a href="ggj://redirect/resource/commonActivitiesList/1781"><img src="${rc.contextPath}/pages/images/endAnniversary/recommend_img05.jpg"/></a>
						</li>
						<li>
							<a href="ggj://redirect/resource/appCustomActivitiesDetail/1010"><img src="${rc.contextPath}/pages/images/endAnniversary/recommend_img06.jpg"/></a>
						</li>
						<li>
							<a href="ggj://redirect/resource/appCustomActivitiesDetail/1009"><img src="${rc.contextPath}/pages/images/endAnniversary/recommend_img07.jpg"/></a>
						</li>
						<li>
							<a href="ggj://redirect/resource/appCustomActivitiesDetail/1011"><img src="${rc.contextPath}/pages/images/endAnniversary/recommend_img08.jpg"/></a>
						</li>
					</ul>
				</div>
			</div>
...
$(function(){
	 ...
	 function countDownTimeX(){
	     $.ajax({
	           type:'POST',
	           url:'${rc.contextPath}/activity/anniversaryNew/refreshTime',
	           data:'',
	           dataType: 'json' ,
     ...
     function timeType(){
	    ...
	    var _oLI = $("#container .timeList-top").find("li");
	     ...
	     $("#container .timeList-top").find("li").on("touchend",function(){
			...
			function beforeSend(){
				$("#timeListUL").html("<li class='loadingImg'><img src='${rc.contextPath}/pages/images/endAnniversary/loading.gif' /></li>")
			}
			$.ajax({
	           type:'POST',
	           url:'${rc.contextPath}/activity/anniversaryNew/getProductDate',
	           data:_data,
