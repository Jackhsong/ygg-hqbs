	...
	<body>
		...
		<div class="page">
			<div class="tit">
				...
				<#else>
				     <a href="${rc.contextPath}/ads/listadsmgr" class="tit_la"><img src="${rc.contextPath}/pages/images/cancle.png" class="tit_center"></a>
				</#if>
		...
		<script type="text/javascript">
		 var  flag = false ;   // 防重复提交
			...
			{
			   document.deleteAddressForm.action="${rc.contextPath}/ads/deleteads/${(address.addressId)!"0"}/${(address.accountId)!"0"}";
			...
			function  sendform(){
			   var  checkflag = checkconsignadd();
			    if(checkflag){
			           if(!flag){
			         		document.form1.action="${rc.contextPath}/ads/ordermodifyads";
