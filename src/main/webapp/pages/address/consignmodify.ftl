	...
	<body>
		...
		<div class="page">
			<div class="tit">
				修改地址
				<!-- 判断
				<a href="${rc.contextPath}/ads/listads" class="tit_la reg">取消</a>
				-->
				<a href="${rc.contextPath}/ads/listads" class="tit_la"><img src="${rc.contextPath}/pages/images/cancle.png" class="tit_center"></a>
			...
			<ul class="insertadd">
			 ...
			 -->
			<!-- 判断是否显示海外购提醒 End -->
			<a href="${rc.contextPath}/ads/deleteads/${(address.addressId)!"0"}/${(address.accountId)!"0"}"><p class="consigndel">删除地址</p></a>
			...
			<#if errorCode?exists>
		       ...
		       showTipMsg(errormsg);
				...
				　$("#saveaddress").click(function(){
				    //document.form1.action="${rc.contextPath}/ads/modifyads";
