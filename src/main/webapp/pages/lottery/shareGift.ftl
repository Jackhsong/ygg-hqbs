...
.text{text-align: center;font-size: .5rem;line-height:0.8rem;color: #713b0f;}
.img1{height: 6.7rem;display: block;margin: 0 auto;}
...
.share span.bgimg{display: inline-block;background: url(${rc.contextPath}/pages/images/shareGiftImages/wx.png) left center no-repeat;padding-left: .6rem;background-size: 15%;}
...
<body>
	...
	<p class="text2">分享成功后，您将获得一张<span>&yen;15</span>无限制现金券</p>
	<p class="share"><a href="ggj://open/resource/share" class="bgcolor"><span class="bgimg">马上分享给好友</span></a></p>
