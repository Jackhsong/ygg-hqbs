...
<head lang="en">
    ...
    <style>
        ...
        #getBtn,.links{width: 4.6rem;height: 0.9rem;top:0;left: 2.5rem;}
...
<div class="main rl" id="main">
    ...
    <section>
        <img src="${rc.contextPath}/pages/images/activity/activityGanenjie/app01.jpg"/>
        <img src="${rc.contextPath}/pages/images/activity/activityGanenjie/app02.jpg"/>
        <div class="relative">
            <#if login>
            ...
            <img src="${rc.contextPath}/pages/images/activity/activityGanenjie/app03.jpg"/>
        </div>
        <img src="${rc.contextPath}/pages/images/activity/activityGanenjie/app04.jpg"/>
        <img src="${rc.contextPath}/pages/images/activity/activityGanenjie/app05.jpg"/>
        <img src="${rc.contextPath}/pages/images/activity/activityGanenjie/app06.jpg"/>
        <img src="${rc.contextPath}/pages/images/activity/activityGanenjie/app07.jpg"/>
        <img src="${rc.contextPath}/pages/images/activity/activityGanenjie/app08.jpg"/>
