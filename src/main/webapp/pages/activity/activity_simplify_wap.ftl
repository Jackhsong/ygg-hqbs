...
<head lang="en">
    ...
    <style>
        ...
        body{font-family:'microsoft yahei';width: 100%;line-height: 150%;padding-bottom:1.3rem;transition:transform 1s ease;}
        ...
        .img img{display: block;height:100%;}
        ...
        .tit{color: #212121;font-size: 0.55rem;width: 95%;display: block;margin-top:.1rem;font-size: 0.43rem;line-height: 130%;margin: 0.1rem auto 0.1rem auto;}
