...
<head lang="en">
    ...
    <style>
        ...
        #getBtn,.links{width: 4.7rem;height: 1.5rem;top: .1rem;left: 2.6rem;}
        .showBox{width: 80%;top:30%;left:5%;background: #fff;border-radius: 5px;padding: 30px 15px 15px 15px;}
    ...
    <div class="opcWrapDiv">
        ...
        <div class="showBox abso">
            ...
            <article class="btnBox">
                <a href="ggj://redirect/account/home">去看看</a><a class="share" href="ggj://open/resource/share">分享给朋友</a>
            </article>
        </div>
    </div>
    <section>
        <img src="${rc.contextPath}/pages/images/activity/activityFoodParty/img01.jpg"/>
        <img src="${rc.contextPath}/pages/images/activity/activityFoodParty/img02.jpg"/>
        <img src="${rc.contextPath}/pages/images/activity/activityFoodParty/img03.jpg"/>
        <img src="${rc.contextPath}/pages/images/activity/activityFoodParty/img04.jpg"/>
        <div class="relative">
            <img src="${rc.contextPath}/pages/images/activity/activityFoodParty/img05.png"/>
            <#if login>
        ...
        <img src="${rc.contextPath}/pages/images/activity/activityFoodParty/img06.png"/>
    </section>
</div>
