...
<head lang="en">
    ...
    <style>
        ...
        .main .phoneNo{height: 1rem;line-height: 1rem;top:0;outline: none; text-align: center;font-size: .4rem;color: #7b390e;border: #e0e0e0 1px solid;box-shadow:1px 1px 5px #B76A6A;-webkit-box-shadow:1px 1px 5px #B76A6A;-moz-box-shadow:1px 1px 5px #B76A6A;-ms-box-shadow:1px 1px 5px #B76A6A;-o-box-shadow:1px 1px 5px #B76A6A;border-radius:5px;background: #f5f5f5;}
...
<div class="main" id="main">
    ...
    <section>
        <img src="${rc.contextPath}/pages/images/activity/activityRedFriday_/web01.png"/>
        <img src="${rc.contextPath}/pages/images/activity/activityRedFriday_/web02.png"/>
        <div class="relative">
            ...
            <img src="${rc.contextPath}/pages/images/activity/activityRedFriday_/web03.png"/>
        </div>
        <img src="${rc.contextPath}/pages/images/activity/activityRedFriday_/web04.png"/>
    </section>
</div>
<script>
    //淘宝H5自适应解决方案
