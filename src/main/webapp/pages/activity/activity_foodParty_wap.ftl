...
<head lang="en">
    ...
    <style>
        ...
        .showBox{width: 80%;top:30%;left:5%;background: #fff;border-radius: 5px;padding: 30px 15px 30px 15px;}
        .showBox p{color: #000000;text-align: center;font-size: .45rem;line-height:150%;}
        .showBox a{width: 3.5rem;background: #e73835;border-radius: 2px;display: inline-block;color: #fff;text-align: center;text-decoration: none;font-size:.5rem;height: 30px;line-height: 30px;margin-top: .6rem;}
        ...
        .showBox article .download{width: 100%;border-radius: 2px;background:#e73835;color: #fff;text-align: center;height: 45px;line-height: 45px;font-size: .5rem;margin-top: .3rem; }
        .main .phoneNo,.main #getBtn{width:5.2rem;left: 2.5rem;}
        .main .phoneNo{height: .8rem;line-height: .8rem;top:-.5rem;text-align: center;font-size: .4rem;color: #000000;border: #d4ba77 1px solid;background: #fff;}
        .main #getBtn{height: .8rem;top: .7rem;}
        .main input::-webkit-input-placeholder{color: #a6a6a6;}
        .main input::-moz-placeholder{color: #a6a6a6;}
        .main input:-ms-input-placeholder{color: #a6a6a6;}
...
<div class="main" id="main">
    <header class="download">
        <a href="javascript:void(0);" onclick="window.open('http://download.gegejia.com')" class="DownLoad" target="_self">
            <img src="http://m.gegejia.com:80/ygg/pages/images/sidebar.png"/>
        </a>
    </header>
    <div class="opcWrapDiv">
        ...
        <div class="showBox abso">
            ...
            <article class="btnBox">
               <a href="http://download.gegejia.com" class="download">下载左岸城堡APP</a>
            </article>
            <i class="close abso"></i>
        </div>
    </div>
    <section>
        <img src="${rc.contextPath}/pages/images/activity/activityFoodParty/w01.jpg"/>
        <img src="${rc.contextPath}/pages/images/activity/activityFoodParty/w02.jpg"/>
        <img src="${rc.contextPath}/pages/images/activity/activityFoodParty/w03.jpg"/>
        <img src="${rc.contextPath}/pages/images/activity/activityFoodParty/w04.jpg"/>
        <div class="relative">
        	<form action="" method="post" id="form1">
        		<input type="hidden" name="requestFrom" value="${requestFrom}"/>
	            <input type="text" name="phoneNumber" class="phoneNo abso" placeholder="输入手机号领取" />
	            <a id="getBtn" class="abso"></a>
	            <img src="${rc.contextPath}/pages/images/activity/activityFoodParty/w05.jpg"/>
            </form>
        </div>
        <img src="${rc.contextPath}/pages/images/activity/activityFoodParty/w06.jpg"/>
    </section>
</div>
<script>
    //淘宝H5自适应解决方案
    ...
    $(function(){
        $('#getBtn').on('click',function(){
            ...
            if(phoneNumber==""){
            	...
            	$.ajax({
                    url:"${rc.contextPath}/activity/foodParty/receive",
                    dataType:'json',
                    data:{phoneNumber:phoneNumber,requestFrom:requestFrom},
                    type: 'post',
                    success:function(data){
                        if(data.status=="1"){
                        	$(".txt").html("两张满599减50元优惠券已放入帐号中，快去买好吃的吧！");
                        	$(".download").show();
                            $('.opcWrapDiv').show().find(".opcWrap").css('height',$(".main").height()+"px").css("padding-bottom","100px");
