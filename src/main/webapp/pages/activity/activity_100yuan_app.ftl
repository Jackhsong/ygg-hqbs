...
<div class="main rl" id="main">
    ...
    <section>
        <img src="${rc.contextPath}/pages/images/activity/activity100yuan/coupon01.jpg"/>
        <img src="${rc.contextPath}/pages/images/activity/activity100yuan/coupon02.jpg"/>
        <img src="${rc.contextPath}/pages/images/activity/activity100yuan/coupon03.jpg"/>
        <div class="relative">
            <#if login>
            ...
            <img src="${rc.contextPath}/pages/images/activity/activity100yuan/coupon04.jpg"/>
        </div>
        <img src="${rc.contextPath}/pages/images/activity/activity100yuan/coupon05.jpg"/>
