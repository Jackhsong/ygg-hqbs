...
<head lang="en">
    ...
    <style>
        ...
        .main .phoneNo,.main #getBtn{width:5.63rem;left: 2.15rem;}
        .main .phoneNo{height: 1rem;line-height: 1rem;top:0;text-align: center;font-size: .4rem;color: #7b390e;border: #7b390e 2px solid;border-radius:5px;background: #fff;}
        .main #getBtn{height: 1rem;top: 1.4rem;}
        .main input::-webkit-input-placeholder{color: #7b390e;}
        .main input::-moz-placeholder{color: #7b390e;}
        .main input:-ms-input-placeholder{color: #7b390e;}
...
<div class="main" id="main">
    ...
    <section>
        <img src="${rc.contextPath}/pages/images/activity/activityGanenjie/web01.jpg"/>
        <img src="${rc.contextPath}/pages/images/activity/activityGanenjie/web02.jpg"/>
        <img src="${rc.contextPath}/pages/images/activity/activityGanenjie/web03.jpg"/>
        <div class="relative">
            ...
            <img src="${rc.contextPath}/pages/images/activity/activityGanenjie/web04.jpg"/>
        </div>
        <img src="${rc.contextPath}/pages/images/activity/activityGanenjie/web05.jpg"/>
    </section>
</div>
<script>
    //淘宝H5自适应解决方案
