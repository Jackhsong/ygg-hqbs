...
;(function ( window, undefined ) {
    ...
    */
        ...
        return {
            ...
            , soundReminder: function () {
                ...
                if ( window.HTMLAudioElement ) {
                    ...
                    me.audio.src = 'http://m.gegejia.com/ygg/pages/huanxin/static/mp3/msg.m4a';
                    me.soundReminder = function () {
    ...
    config.LOADING = !utils.isQQBrowserInAndroid && !(utils.getIEVersion() && utils.getIEVersion() == 9)//消息loading
        ...
        "c2.8,0,5.3,1,7.3,2.8'/><image src='http://m.gegejia.com/ygg/pages/huanxin/static/img/loading.gif' width='20' style='margin-top:10px;' /></svg></div>"].join('')
        : "<img src='http://m.gegejia.com/ygg/pages/huanxin/static/img/loading.gif' width='20' style='margin-top:10px;'/>";
    Easemob.im.EMOTIONS = {//表情集
        path: 'http://m.gegejia.com/ygg/pages/huanxin/static/img/faces/'
        , map: {
            '[):]': 'ee_1.png',
            '[:D]': 'ee_2.png',
            '[;)]': 'ee_3.png',
