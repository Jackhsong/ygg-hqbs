;(function () {
    ...
    easemobIM.config.defaultAvatar = setDefault(easemobIM.config.defaultAvatar, 'http://m.gegejia.com/ygg/pages/huanxin/static/img/avatar.png');//默认头像
    ...
    link.href = 'http://m.gegejia.com/ygg/pages/huanxin/static/css/im.css';
    ...
    document.getElementById('EasemobKefuWebimIframe').onload = function () {
        ...
        var loadIm = function () {
            ...
            script.src = 'http://m.gegejia.com/ygg/pages/huanxin/static/js/im.js';
